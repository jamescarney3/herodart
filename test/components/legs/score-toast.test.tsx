...
import ScoreToast, { ELIMINATED, STRIKE_INCURRED, NO_STRIKE_INCURRED } from '~/components/legs/score-toast';
...
describe('ScoreToast', () => {
  ...
  it('renders valid score content when score is valid', () => {
    ...
    expect(container.textContent).toBe(NO_STRIKE_INCURRED);
  });
  ...
  it('renders eliminated content for eliminating score', () => {
    ...
    expect(container.textContent).toBe(ELIMINATED);
  });
  ...
  it('renders strike incurred content for strike score', () => {
    ...
    expect(container.textContent).toBe(STRIKE_INCURRED);
  });
